          ...
          <div className="bg-white/10 backdrop-blur-2xl border border-white/20 shadow-2xl rounded-3xl p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-8">
                ...
                <h1 className="text-3xl font-bold text-white mb-2">Join as Freelancer</h1>
                <p className="text-gray-300">Showcase your skills and find amazing projects</p>
              </div>
              ...
              <div className="mt-8 p-4 bg-white/5 rounded-2xl border border-white/10">
                ...
                <div className="space-y-2 text-sm text-gray-300">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Access to high-quality projects</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-green-400">✓</span>
